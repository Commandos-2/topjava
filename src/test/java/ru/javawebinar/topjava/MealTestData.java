...
public class MealTestData {
    ...
    public static final Meal adminMeal2 = new Meal(ADMIN_MEAL_ID, of(2020, Month.JANUARY, 31, 21, 0), "Админ ужин", 1500);

    public static final List<Meal> mealsUser = List.of(meal7, meal6, meal5, meal4, meal3, meal2, meal1);
    public static final List<Meal> mealsAdmin = List.of(adminMeal1,adminMeal2);
