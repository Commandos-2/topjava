...
public abstract class AbstractMealServiceTest extends AbstractServiceTest {
    ...
    public void createWithException() {
        ...
        if (checkJdbcProfile()) {
            validator.validate(new Meal(USER_ID, of(2015, Month.JUNE, 1, 18, 0), "  ", 300));
            validator.validate(new Meal(USER_ID, null, "Description", 300));
            validator.validate(new Meal(USER_ID, of(2015, Month.JUNE, 1, 18, 0), "Description", 9));
            validator.validate(new Meal(USER_ID, of(2015, Month.JUNE, 1, 18, 0), "Description", 5001));
        } else {
